...
void newSkills() {
  ...
  move_to_target_sync(21.5,-40,-M_PI,false,65);
  move_to_target_sync(13,-18,-M_PI/2,false);
  fBar.move_absolute(FBAR_MID+200,200);
  while(fBar.get_position() < FBAR_MID) delay(1);
  move_to_target_sync(5,-18,-M_PI/2,false,75);
  intakeReverse();
  delay(800);
  move_to_target_sync(23.5, -7.5, M_PI/2,false);
  return;
